					...
					<div class="pricing-item entermediate">
						...
						<div class="wrapper">
							<form method="post" class="form-signin">
								...
								<input type="text" name="email" id="email" placeholder="Your Email" autocomplete="off" required class="form-control"  />
								...
								<button type="submit" id="submit" name="submit" value="login" class="btn btn-lg btn-primary btn-block" type="submit">Login</button>
								<a href="registration.php" class="btn btn-lg btn-success btn-block" type="button">Register</a>
							</form>
						</div>
